...
import { Rocket, Zap, Users, BarChart, Shield, ArrowRight } from "lucide-react";
  ...
  const features = [
    {
      ...
      description:
        "Automate repetitive tasks and get intelligent project insights with our built-in Gemini engine.",
      icon: Zap,
    },
    {
      title: "Real-time Collaboration",
      description:
        "Work together seamlessly with live cursors, instant notifications, and integrated team chat.",
      icon: Users,
    },
    {
      title: "Advanced Analytics",
      description:
        "Visualize team velocity and project health with beautiful, interactive charts and data dashboards.",
      icon: BarChart,
    },
    {
      title: "Enterprise Security",
      description:
        "Role-based access control, SSO, and audit logs keep your team's sensitive data safe and compliant.",
      icon: Shield,
    },
  ];
        ...
        <section className="pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
              ...
              >
                Project management <span className="text-primary">evolved</span>{" "}
                with AI.
              </motion.h1>
              ...
              >
                AtlasDesk combines intuitive task management with powerful
                generative AI to help your team ship faster, smarter, and
                together.
              </motion.p>
            ...
            >
              <Image
                ...
                loading="lazy"
                placeholder="blur"
                blurDataURL="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThotrk8MvJ4FBRWSKQejdUmi6nlLn05WogeJVCEmd8&s"
              />
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
              ...
              <p className="text-muted-foreground text-lg">
                Powerful features built for teams of all sizes.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto p-12 md:p-20 rounded-[3rem] bg-primary text-primary-foreground text-center space-y-8 shadow-2xl">
              ...
              <p className="text-xl opacity-90 max-w-xl mx-auto">
                Join thousands of teams who are already building the future with
                AtlasDesk.
              </p>
